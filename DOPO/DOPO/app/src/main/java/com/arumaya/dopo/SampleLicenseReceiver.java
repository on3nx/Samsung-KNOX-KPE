...
public class SampleLicenseReceiver extends BroadcastReceiver {
    ...
    private void showToast(Context context, int msg_res) { Toast.makeText(context, context.getResources().getString(msg_res), Toast.LENGTH_SHORT).show(); }
    private void showToast(Context context, String msg) { Toast.makeText(context, msg, Toast.LENGTH_SHORT).show(); }
        ...
        if (intent == null) {
            ...
            if (action == null) {
                ...
                if (errorCode == KnoxEnterpriseLicenseManager.ERROR_NONE) {
                    ...
                    showToast(context, R.string.klm_activated_succesfully);
                    Log.d("SampleLicenseReceiver", context.getString(R.string.klm_activated_succesfully));
                    return;
                } else {
